...
import 'package:tenorio_flutter/theme.dart';
import 'package:tenorio_flutter/main.dart'; // Importa MyTheme desde theme.dart
          ...
          return Scaffold(
            ...
            body: Center(
              child: Container(
                ...
                child: Image.asset(
                  'assets/spotify_logo.png', // Ruta de tu imagen
